...
> Live site: [jerahmeelhipolito.github.io](https://jerahmeel-hipolito.github.io/Portfolio/)

---

## About This Repository

This repository hosts my personal portfolio website and sample instructional design coursework. The portfolio showcases my background in e-learning development, curriculum design, and applied statistics.
...
Each course was built with **Articulate Rise 360** and exported as HTML5. They are hosted here as standalone folders and launch directly in the browser.
...
## How to Upload Your Course Folders
...
> **Note:** Rise 360 HTML5 exports contain an `index.html` at the root of each folder. GitHub Pages serves this automatically when you visit `https://yourusername.github.io/courses/intro-to-rise360/`.
...
*Portfolio designed and built by Jerahmeel Hipolito · 2025*
